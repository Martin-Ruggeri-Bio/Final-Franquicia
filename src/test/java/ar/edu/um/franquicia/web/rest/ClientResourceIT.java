...
import ar.edu.um.franquicia.repository.ClientRepository;
import ar.edu.um.franquicia.service.ClientService;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().userName(DEFAULT_USER_NAME);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().userName(UPDATED_USER_NAME);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.userName(UPDATED_USER_NAME);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.userName(UPDATED_USER_NAME);
